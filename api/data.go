...
type Account struct {
	...
	WitnessesVoteWeight    int64           `json:"witnesses_vote_weight"`
...
type Config struct {
	...
	ConsensusBandwidthReservePercent string    `json:"CONSENSUS_BANDWIDTH_RESERVE_PERCENT"`
	ConsensusBandwidthReserveBelow   string    `json:"CONSENSUS_BANDWIDTH_RESERVE_BELOW"`
	...
	InitSupply                       types.Int `json:"CHAIN_INIT_SUPPLY"`
	...
	IrreversibleSupportMinRun        string    `json:"CHAIN_IRREVERSIBLE_SUPPORT_MIN_RUN"`
	...
	MaxMemoLength                    string    `json:"CHAIN_MAX_MEMO_LENGTH"`
	...
	MaxSupportWitnesses              string    `json:"CHAIN_MAX_SUPPORT_WITNESSES"`
	...
	MaxTopWitnesses                  string    `json:"CHAIN_MAX_TOP_WITNESSES"`
	...
	MaxBlockSizeLimit                string    `json:"CHAIN_MAX_BLOCK_SIZE_LIMIT"`
	NullAccount                      string    `json:"CHAIN_NULL_ACCOUNT"`
	NumInitiators                    string    `json:"CHAIN_NUM_INITIATORS"`
	...
	EnergyRegenerationSeconds        string    `json:"CHAIN_ENERGY_REGENERATION_SECONDS"`
	TokenSymbol                      string    `json:"TOKEN_SYMBOL"`
	SharesSymbol                     string    `json:"SHARES_SYMBOL"`
	ChainName                        string    `json:"CHAIN_NAME"`
	BlockGenerationPostponedTxLimit  string    `json:"CHAIN_BLOCK_GENERATION_POSTPONED_TX_LIMIT"`
	PendingTransactionExecutionLimit string    `json:"CHAIN_PENDING_TRANSACTION_EXECUTION_LIMIT"`
}
...
type Witness struct {
	...
	CountedVotes          int64                 `json:"counted_votes"`
